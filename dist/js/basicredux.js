...
var Main = function Main(props) {
    var randomFood = function randomFood() {
        var foods = ['hotdog', 'burger', 'slider', 'carrot'];
        return foods[Math.floor(Math.random() * foods.length)];
    };
    var food = randomFood();

    var clickHandler = function clickHandler(food) {
        props.eatFood(food);
    };
    ...
    return _react2.default.createElement(
        'div',
        null,
        'Hello, I am munching on ',
        _react2.default.createElement(
            'ul',
            null,
            props.foods.map(function (food, i) {
                return _react2.default.createElement(
                    'li',
                    { key: i },
                    food
        ...
        _react2.default.createElement(
            'button',
            { onClick: clickHandler.bind(null, food) },
            'Feed me!'
        )
    );
};
...
var App = (0, _reactRedux.connect)(mapState, mapDispatch)(Main);
...
var store = exports.store = (0, _redux.createStore)(_reducers2.default, initialState);
...
var foods = function foods() {
    ...
    switch (action.type) {
        case 'EAT_FOOD':
            return [].concat(_toConsumableArray(state), [action.food]);
        default:
            return state;
    }
};
...
var EAT = 'EAT_FOOD';
var eatFood = exports.eatFood = function eatFood(food) {
    type: EAT_FOOD, food;
};
